...
# contains all of the packages required to build this version of Resistance.
#
# This script assumes you've just built Resistance, and that as a result of that
