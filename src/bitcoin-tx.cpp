...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Resistance resistance-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  resistance-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded resistance transaction") + "\n" +
              "  resistance-tx [options] -create [commands]   " + _("Create hex-encoded resistance transaction") + "\n" +
              "\n";
