...
int printMiningStatus(bool mining)
{
    ...
    if (mining) {
        ...
        std::cout << _("To enable mining, add 'gen=1' to your resistance.conf and restart.") << std::endl;
        lines += 2;
    }
    std::cout << std::endl;
...
void ThreadShowMetricsScreen()
{
    ...
    RenameThread("resistance-metrics-screen");
    ...
    if (isScreen) {
        ...
        // Thank you text
        std::cout << strprintf(_("Thank you for running a %s Resistance node!"), WhichNetwork()) << std::endl;
    ...
    while (true) {
        ...
        if (isScreen) {
            ...
            std::cout << "[";
#ifdef WIN32
            std::cout << _("'resistance-cli.exe stop' to exit");
#else
