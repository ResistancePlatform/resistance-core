...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    BOOST_CHECK_EQUAL(find_value(obj, "por").get_real(), 2.5);
    BOOST_CHECK_EQUAL(find_value(obj, "dev").get_real(), 2.5);
    ...
    BOOST_CHECK_EQUAL(find_value(obj, "por").get_real(), 0.0);
    BOOST_CHECK_EQUAL(find_value(obj, "dev").get_real(), 0.0);
...
BOOST_AUTO_TEST_CASE(rpc_z_mergetoaddress_parameters)
{
    ...
    CheckRPCThrows("z_mergetoaddress 1 2",
        "Error: z_mergetoaddress is disabled. Run './resistance-cli help z_mergetoaddress' for instructions on how to enable this feature.");
